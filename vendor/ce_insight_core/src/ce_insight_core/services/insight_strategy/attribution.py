...
class AttributionStrategy(InsightStrategy):
    ...
    def execute(self, **kwargs) -> None:
        ...
        from ce_insight_core.services.insight_strategy.chart_style import (
            truncate_labels, base_title, base_tooltip, HIGHLIGHT_RED, HIGHLIGHT_GREEN, BLUE, PALETTE,
        )
        ...
        # 饼图数据：取绝对值
        pie_data = [{"name": l, "value": round(abs(v), 2)}
                    for l, v in zip(labels, pct_vals) if abs(v) >= 1]
        ...
        self._chart_configs = {
            ...
            "xAxis": {"type": "value", "name": "贡献度(%)", "nameTextStyle": {"fontSize": 11},
                      "gridIndex": 0},
            ...
            "series": [
                {
                    ...
                    "barMaxWidth": 24, "xAxisIndex": 0, "yAxisIndex": 0,
